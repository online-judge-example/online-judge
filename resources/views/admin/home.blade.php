    ...
    <div class="container">
        <div class="row border rounded">
            ...
            <div class="col-md-10 ml-sm-auto col-lg-10 px-4 pt-3 mb-5">
                <form action="{{route('admin.admin.home')}}" method="get">
                    ...
                    <table class="table text-left" id="problemList">
                        ...
                        @foreach($users as $user)
                            <tr>
                                ...
                                <td>
                                    @if($user->user_type == 1) <a href="{{route('admin.admin.changeuser', ['id'=> $user->id])}}">Setter</a>
                                    @else  <a href="{{route('admin.admin.changeuser', ['id'=> $user->id])}}">Practice</a> @endif
                                </td>
